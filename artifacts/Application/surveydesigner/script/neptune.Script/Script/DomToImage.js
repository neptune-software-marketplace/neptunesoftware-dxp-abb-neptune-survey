!(function (a) {
    ...
    function g(a) {
        "undefined" == typeof a.imagePlaceholder
            ? (w.impl.options.imagePlaceholder = v.imagePlaceholder)
            : (w.impl.options.imagePlaceholder = a.imagePlaceholder),
            "undefined" == typeof a.cacheBust
                ? (w.impl.options.cacheBust = v.cacheBust)
                : (w.impl.options.cacheBust = a.cacheBust);
    }
    function h(a, c) {
        function d(a) {
            var b = document.createElement("canvas");
            if (
                ((b.width = c.width || p.width(a)), (b.height = c.height || p.height(a)), c.bgcolor)
            ) {
