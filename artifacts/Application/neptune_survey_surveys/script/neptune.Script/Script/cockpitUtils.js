const cockpitUtils = {
    ...
    init: function () {
        ...
        cockpitUtils.dataSet = "Neptune SURVEY Survey";

        // Required Fieldnames for data validation
        cockpitUtils.requiredFields = ["inpageSurveyDetailSurveyname"];
    },
    ...
    lock: function () {
        ...
        sap.n.Planet9.function({
            ...
            data: {
                ...
                objectID: modelSurveyMaster.oData.survey.id,
                objectKey: modelSurveyMaster.oData.survey.name,
            },
            success: function (data) {
                ...
                if (data.object) {
                    ...
                    controller.get(modelSurveyMaster.oData.survey.id, true);
                }
            },
    ...
    unlock: function () {
        const toggleDisplay = () => {
            oApp.setBusy(false);
            controller.get(modelSurveyMaster.oData.survey.id, false);
        };
        ...
        // Check for changes
        if (cockpitUtils.dataSaved !== modelSurveyMaster.getJSON()) {
