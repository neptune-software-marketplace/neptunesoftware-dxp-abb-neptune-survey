!(function (a) {
    ...
    function f(a, b) {
        return h(a, b || {}).then(p.canvasToBlob);
    }
    function g(a) {
        "undefined" == typeof a.imagePlaceholder ? (w.impl.options.imagePlaceholder = v.imagePlaceholder) : (w.impl.options.imagePlaceholder = a.imagePlaceholder),
            "undefined" == typeof a.cacheBust ? (w.impl.options.cacheBust = v.cacheBust) : (w.impl.options.cacheBust = a.cacheBust);
    }
    function h(a, c) {
        function d(a) {
        ...
        function i(a) {
            return new Promise(function (b, c) {
                ...
                (d.onload = function () {
                    ...
                    (d.onerror = c),
                    t || u ? (d.src = encodeURI(a)) : (d.src = a);
            });
        }
        function j(a) {
            var b = 3e4;
            return (
                w.impl.options.cacheBust && (a += (/\?/.test(a) ? "&" : "?") + new Date().getTime()),
                new Promise(function (c) {
                    ...
                    if (w.impl.options.imagePlaceholder) {
                        var i = w.impl.options.imagePlaceholder.split(/,/);
                        i && i[1] && (h = i[1]);
                    }
                })
            );
    ...
    var p = l(),
        ...
        w = {
            ...
            toBlob: f,
            toPixelData: c,
            impl: { fontFaces: r, images: s, util: p, inliner: q, options: {} },
        };
    domtoimage = w;
    // "undefined" != typeof module ? (module.exports = w) : (a.domtoimage = w);
})(this);
